...
#### 4.3. 디렉토리 구조
```
Capstone-2025-team-29
├── code
│   ├── AiChaserBE        # FastAPI 기반 백엔드 서버
│   ├── HearoIOS          # iOS 프로젝트
│   ├── HearoMQTT         # MQTT 브로커 및 핸들러 관련 코드
│   ├── HearoROS          # ROS2 관련 패키지 및 서비스 코드
│   ├── HearoRTSP         # RTSP 스트리밍 관련 코드 및 웹 뷰어
│   └── HearoSound        # 소리 처리
├── docs                  # 보고서, 포스터, 발표자료 등 문서 산출물
```
...
앱은 **TestFlight**를 통해 설치 및 테스트할 수 있으며,  
참여를 위해서는 이메일 주소가 필요합니다.
...
| [이민경](https://github.com/mingkyeongg) | [박지용](https://github.com/Bentlytrucker) | [이진솔](https://github.com/mogld) |
|:----------------------------------------:|:------------------------------------------:|:----------------------------------:|
| 📱 **Mobile / Infra** <br> _"그동안 해보지 않았던 ios 앱이나 로봇에 대해 알 수 있는 시간이였습니다. 좋은 팀원들을 만나 이렇게 잘 마무리 한 것 같습니다."_ | 🤖 **AI / SLAM** <br> _"이번 프로젝트를 통해 AI 모델 알고리즘을 직접 구현해보았습니다. 처음에는 많이 어렵고 감도 안와서 많이 헤맸지만 돌이켜보니 좋은 추억을 쌓은 것 같습니다."_ | 🛠️ **Backend / DB** <br> _"하나의 온전한 서비스를 만들며 협업의 중요성을 알게 되었습니다. 아쉬움도 많이 남지만 졸업과제를 준비하던 시간 덕에 많이 성장했습니다."_ |
